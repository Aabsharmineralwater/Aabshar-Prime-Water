...
export default function BottomNav({ onLinkClick }: BottomNavProps) {
  ...
  return (
    <div className="fixed bottom-3 left-3 right-3 z-40 bg-white/95 backdrop-blur-xl border border-slate-200 shadow-xl rounded-2xl md:hidden pb-safe overflow-hidden">
      <div className="flex items-center justify-around h-16 px-1 max-w-md mx-auto">
        ...
        <button
          ...
          style={{ minWidth: '44px' }}
        >
          <div className="w-9 h-9 rounded-full flex items-center justify-center bg-[#25D366] text-white shadow-md group-hover:scale-105 transition-transform">
            <svg viewBox="0 0 24 24" className="w-4.5 h-4.5 fill-current text-white" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-[10px] tracking-wide text-center font-bold text-emerald-600">
            WhatsApp
          </span>
        </button>
