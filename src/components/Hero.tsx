          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left">
            ...
            >
              ...
              <div className="relative inline-flex flex-col items-center justify-center mx-auto pb-4">
                ...
                {/* Clean Water Ripple & Glow Pedestal directly below bottle bases */}
                <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-64 sm:w-72 h-14 pointer-events-none z-0 flex items-center justify-center">
                  {/* Soft Water Base Pool */}
                  <div className="w-56 sm:w-64 h-8 rounded-[100%] bg-gradient-to-r from-sky-200/40 via-sky-300/45 to-sky-200/40 blur-md" />
                  
                  {/* Inner Water Reflection Ellipse */}
                  <div className="absolute w-44 sm:w-52 h-6 rounded-[100%] bg-sky-100/60 blur-[2px]" />

                  {/* Concentric Clean Water Rings */}
                  <div className="absolute w-48 sm:w-56 h-7 rounded-[100%] border border-[#0284C7]/30 shadow-xs" />
                  <div className="absolute w-56 sm:w-64 h-9 rounded-[100%] border border-sky-300/40" />
                  <div className="absolute w-64 sm:w-72 h-11 rounded-[100%] border border-sky-200/30" />

                  {/* SVG Water Surface Reflections */}
                  <svg viewBox="0 0 200 40" className="absolute inset-0 w-full h-full pointer-events-none" fill="none">
                    <circle cx="22" cy="18" r="2" fill="#0284C7" opacity="0.6" />
                    <circle cx="36" cy="12" r="1.5" fill="#38bdf8" opacity="0.6" />
                    <circle cx="164" cy="12" r="1.5" fill="#38bdf8" opacity="0.6" />
                    <circle cx="178" cy="18" r="2" fill="#0284C7" opacity="0.6" />
                    
                    <ellipse cx="100" cy="20" rx="78" ry="11" stroke="#0284C7" strokeWidth="1" strokeDasharray="6 4" opacity="0.4" />
                    <ellipse cx="100" cy="20" rx="52" ry="7" stroke="#38bdf8" strokeWidth="0.8" opacity="0.5" />
                  </svg>
                </div>
              </div>
          ...
          <div className="hidden lg:col-span-5 lg:flex justify-end select-none">
            ...
            >
              ...
              <div className="relative flex flex-col items-center justify-center h-[520px] lg:h-[570px] w-full pb-6">
                ...
                {/* Clean Water Ripple & Glow Pedestal directly below desktop bottle bases */}
                <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-96 lg:w-[460px] h-20 pointer-events-none z-0 flex items-center justify-center">
                  {/* Soft Water Base Pool */}
                  <div className="w-80 lg:w-96 h-12 rounded-[100%] bg-gradient-to-r from-sky-200/40 via-sky-300/50 to-sky-200/40 blur-lg" />
                  
                  {/* Inner Water Reflection Ellipse */}
                  <div className="absolute w-72 lg:w-84 h-9 rounded-[100%] bg-sky-100/60 blur-[3px]" />

                  {/* Concentric Clean Water Rings */}
                  <div className="absolute w-76 lg:w-88 h-11 rounded-[100%] border border-[#0284C7]/35 shadow-xs" />
                  <div className="absolute w-88 lg:w-[410px] h-14 rounded-[100%] border border-sky-300/40" />
                  <div className="absolute w-96 lg:w-[460px] h-16 rounded-[100%] border border-sky-200/30" />
                  
                  {/* SVG Water Surface Reflections */}
                  <svg viewBox="0 0 300 50" className="absolute inset-0 w-full h-full pointer-events-none" fill="none">
                    <circle cx="28" cy="24" r="2.5" fill="#0284C7" opacity="0.6" />
                    <circle cx="48" cy="15" r="2" fill="#38bdf8" opacity="0.6" />
                    <circle cx="252" cy="16" r="2" fill="#38bdf8" opacity="0.6" />
                    <circle cx="272" cy="25" r="2.5" fill="#0284C7" opacity="0.6" />
                    
                    <ellipse cx="150" cy="25" rx="125" ry="15" stroke="#0284C7" strokeWidth="1" strokeDasharray="8 5" opacity="0.4" />
                    <ellipse cx="150" cy="25" rx="85" ry="10" stroke="#38bdf8" strokeWidth="0.8" opacity="0.5" />
                  </svg>
                </div>
              </div>
